...
*/
if (is_cli()) {
    $config['base_url'] = 'http://localhost/influencers/';
} else {
...
|
*/
$config['encryption_key'] = 'CTKXRM7IVYMSNLZ2W1G8BEP4OA0WPGS4';
...
if (is_cli()) {
    $config['sess_cookie_name'] = md5(preg_replace("(^https?://)", '', $config['base_url']).'1');
} else {
    $config['sess_cookie_name'] = md5($_SERVER['HTTP_USER_AGENT'].preg_replace("(^https?://)", '', $config['base_url']).'1');
}
