<div class="card">
    <form id="form-create" method="POST">
        <div class="card-header">
            <h3 class="card-title">New Master Influencer</h3>
        </div>
        <div class="card-body row">
            ...
            <div class="form-group col-12 col-md-6">
                ...
                <input type="number" step="0.01" class="form-control" placeholder="Engagement Rate" name="engagement_rate" id="engagement_rate" min="0" required />
            </div>
            <div class="form-group col-12 col-md-6">
                <label for="followers">Followers <span class="text-danger">*</span></label>
                <input type="number" class="form-control" placeholder="Followers" name="followers" id="followers" min="0" required />
            </div>
            <div class="form-group col-12">
